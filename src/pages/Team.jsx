...
const Team = () => {
  return (
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-12 max-w-[320px] mx-auto">
...
{/* team member  */}
      ...
      {teamMembers.map((member) => (
        <div
          key={member.name}
          className="relative flex flex-col p-4 bg-gradient-to-b from-gray-100 to-gray-50 rounded-xl shadow-md w-full h-auto overflow-hidden border border-gray-300"
        >
